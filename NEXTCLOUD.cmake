...
if(NEXTCLOUD_DEV)
    set( APPLICATION_NAME       "Chili ClouDev" )
    set( APPLICATION_SHORTNAME  "Chili CloudDev" )
    set( APPLICATION_EXECUTABLE "Chili CloudDev" )
    set( APPLICATION_ICON_NAME  "Chili Cloud" )
else()
    set( APPLICATION_NAME       "Chili Cloud" )
    set( APPLICATION_SHORTNAME  "Chili Cloud" )
    set( APPLICATION_EXECUTABLE "Chili Cloud" )
    set( APPLICATION_ICON_NAME  "${APPLICATION_SHORTNAME}" )
endif()

set( APPLICATION_CONFIG_NAME "${APPLICATION_EXECUTABLE}" )
set( APPLICATION_DOMAIN     "chilisecurity.com" )
set( APPLICATION_VENDOR     "Chili Security ApS" )
set( APPLICATION_UPDATE_URL "https://updates.nextcloud.org/client/" CACHE STRING "URL for updater" )
set( APPLICATION_HELP_URL   "https://www.chilisecurity.dk/support" CACHE STRING "URL for the help menu" )

set( APPLICATION_ICON_SET   "SVG" )
set( APPLICATION_SERVER_URL "https://nc.streetfooddistrict.dk/" CACHE STRING "URL for the server to use. If entered, the UI field will be pre-filled with it" )
set( APPLICATION_SERVER_URL_ENFORCE ON ) # If set and APPLICATION_SERVER_URL is defined, the server can only connect to the pre-defined URL
set( APPLICATION_REV_DOMAIN "com.chilisecurity.chilicloud" )
set( DEVELOPMENT_TEAM "" CACHE STRING "Apple Development Team ID" )
set( APPLICATION_VIRTUALFILE_SUFFIX "Chili Cloud" CACHE STRING "Virtual file suffix (not including the .)")
set( APPLICATION_OCSP_STAPLING_ENABLED OFF )
set( APPLICATION_FORBID_BAD_SSL OFF )

set( LINUX_PACKAGE_SHORTNAME "Chili Cloud" )
...
## Theming options
set(NEXTCLOUD_BACKGROUND_COLOR "#bb163b" CACHE STRING "Default Chili background color")
